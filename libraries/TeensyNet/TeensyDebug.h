...
const uint32_t esp8266Debug    = (lcd1wLED        << 1); // 0x10000000; // 268425456 esp8266 debug on
...
//uint32_t setDebug = (udpDebug | eepromDebug);
//uint32_t setDebug = (chipStatusLED | udpProcessLED | glcd1WLED | lcd1wLED);
